...
hello-rails-frontend is simple react application that displays greeting message recieved from the API provided from [hello-rails-backend](https://github.com/Log-benjamin/Hello-Rails-Backend)
